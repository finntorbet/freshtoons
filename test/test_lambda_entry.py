...
def mock_settings_env_vars():
    patch.dict(os.environ, {"client_id": "1234"})
    patch.dict(os.environ, {"client_secret": "4321"})


@patch('src.lambda_entry.os')
def test_update_happy_path(os, mocker):
    os_instance = os.return_value
    os_instance.environ('client')
